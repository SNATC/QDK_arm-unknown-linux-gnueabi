...
#define HW_RT1900ac	"RT1900ac"      //"RT1900ac"
#define HW_RT1900acv10	HW_RT1900ac"v10"      //"RT1900acv10"
#define HW_RT1900acv20	HW_RT1900ac"v20"      //"RT1900acv20"
...
typedef enum {
    SYNO_USB_MAINTANCE_UNMOUNT = 0,
	SYNO_USB_MAINTANCE_MOUNT,
	SYNO_USB_MAINTANCE_PLUGOUT,
	SYNO_USB_MAINTANCE_REFRESH,
	SYNO_USB_MAINTANCE_NOT_MOUNT,
} SYNO_USB_MAINTANCE_TYPE;
...
#if defined(CONFIG_SYNO_QUALCOMM_IPQ806X)
typedef enum {
...
#endif /* defined(CONFIG_SYNO_QUALCOMM_IPQ806X) */
